...
function App() {
  ...
  function FirstImg(){
    return(
      <div className='img_firstImg'><img id="img_firstImg" alt= "imagem de campanha" src="./img/joana_micCapa.jpeg"></img></div>
      )
  }
  ...
  function CarouselImage(){
    return(
      <div className="img_carousel" data-aos='fade-up'>
             <img id="img_apresentation" alt="deputada Joana Darc"src="./img/joana_plen.jpg"></img>
      </div>
    )
    ...
    data-aos-duration="1000">
        <div className='projects_div'>
          ...
          <div className='video_um' data-aos='fade-right'>
              <video controls src='./img/joana_video.mp4'></video>      
          </div> 
